                    ...
                    <div key={blog.id} className="w-4/5 mx-auto md:mx-0 mb-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 pb-7">
                        ...
                        <div className="flex justify-between items-center my-3">
                            ...
                            <div className="flex text-gray-800 me-3">
                                <a href="#">{blog.reading_time} min read</a>
                                <a onClick={()=>handleBookMark(blog.title)} href="#">
                        ...
                        <div className="px-5">
                            ...
                            <a onClick={()=>handleClick(blog.reading_time)} href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Mark as read
                            </a>
                        </div>
                    </div>
